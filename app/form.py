...
class patient_form(forms.Form):
    ...
    sym2 = forms.ChoiceField(widget=forms.Select(attrs={'class': "form-control"}), choices=MY_CHOICES)
    sym3 = forms.ChoiceField(widget=forms.Select(attrs={'class': "form-control"}), choices=MY_CHOICES)
